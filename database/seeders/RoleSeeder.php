...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create(['name' => 'admin.posts.index'])->syncRoles([$role2]);
        Permission::create(['name' => 'admin.posts.create'])->syncRoles([$role2]);
        Permission::create(['name' => 'admin.posts.edit'])->syncRoles([$role2]);
        Permission::create(['name' => 'admin.posts.destroy'])->syncRoles([$role2]);
